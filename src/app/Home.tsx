    ...
    <Grid>
      <Grid.Row>
        <div className="about-me">
          ...
          <p>
            Hi I'm Prajwal Kotian a Senior Frontend/Fullstack Lead and Technical
            Specialist in frontend technologies. I am an enthusiastic,
            self-motivated and hard working person. I have an expereince leading
            the team and very flexible to work in different technologies. I work
            well under pressure and adaptable to all challenging situation.
          </p>
          <p>
            This website provides you my journey and my professional expereince
            details
          </p>
        </div>
      </Grid.Row>
